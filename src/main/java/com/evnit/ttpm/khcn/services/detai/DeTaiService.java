...
public interface DeTaiService {
    ...
    int insertHoiDong(List<DanhSachThanhVien> listDanhSachThanhVien, String maDeTai, String NguoiTao, String NguoiSua,int loaiHD) throws Exception;
    ...
    int insertTLHD(DeTaiReq deTaiReq, String maDeTai) throws Exception;
    int insertTLHDNT(DeTaiReq deTaiReq, String maDeTai) throws Exception;
    ...
    List<Folder> ListFolderFileHOIDONGNT() throws Exception;

    List<Folder> ListFolderFileThanhLapHD() throws Exception;
    List<Folder> ListFolderFileThanhLapHDNT() throws Exception;
    ...
    List<DanhSachThanhVien> ListHDByMaDeTai(String maDeTai,int loaiHD) throws Exception;
